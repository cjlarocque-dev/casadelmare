...
- [ ] **Add new website sections** - Implement 5 new sections: (1) Welcome section with property intro, (2) House Guide with instructions/tips, (3) Referral Rewards program info, (4) Return Guest Discounts, (5) Guest Wall with photo upload feature. 
  - **Guest Wall form fields:** Email, First Name, Last Name, City, State, Phone Number, Photo Upload
